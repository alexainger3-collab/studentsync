  ...
  return (
    <div className="ss-root" style={{ background: COLORS.ink, borderRadius: 20, padding: "40px 16px" }}>
      ...
      <form onSubmit={submit} style={{
        ...
        <input className="ss-input" type="password" required autoComplete="current-password" style={{ marginTop: 6, marginBottom: 14 }}
        ...
        <button className="ss-btn-primary" type="submit" disabled={submitting} style={{ width: "100%", justifyContent: "center" }}>
          {submitting ? <Loader2 size={15} style={{ animation: "spin 1s linear infinite" }} /> : <LogIn size={15} />}
          Log in
        </button>
